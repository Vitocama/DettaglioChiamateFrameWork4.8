...
namespace DettaglioChiamate
{
    ...
    public partial class frmFatturazioneListaChiamatePerCliente : Form
    {
        ...
        private DataTable CalcolaSecondi()
        {
            ...
            dt.Columns.Remove("SpesaAddebitabile");
       ...
       voipdettaglio.data >= @inizio AND voipdettaglio.data <= @fine ";
        ...
        private string ClnSpesaAddebitabileClone()
        {
            ...
            sql = @"
                    ...
                    set ImportoChiamata=round(AddebitoTotalePerTipo.spesa,2)
                    from (
                    select Contratto,sum(ImportoChiamata)as spesa,tipo
                    from voiptmplistachiamate
                    group by contratto,tipo
                    ) as AddebitoTotalePerTipo
                    where VoiptmpListaChiamateClone.Tipo=AddebitoTotalePerTipo.tipo
